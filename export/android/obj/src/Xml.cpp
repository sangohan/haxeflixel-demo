...
HX_STACK_FRAME("Xml","__init__",0xbec8a6e7,"Xml.__init__","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Xml.hx",403,0x7fbf4a5e)
{
	HX_STACK_LINE(404)
...
::String Xml_obj::get_nodeName( ){
	HX_STACK_FRAME("Xml","get_nodeName",0x38fd668d,"Xml.get_nodeName","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Xml.hx",168,0x7fbf4a5e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(169)
...
::String Xml_obj::get( ::String att){
	HX_STACK_FRAME("Xml","get",0x2e441e5f,"Xml.get","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Xml.hx",197,0x7fbf4a5e)
	HX_STACK_THIS(this)
...
Dynamic Xml_obj::elements( ){
	HX_STACK_FRAME("Xml","elements",0x0310ffce,"Xml.elements","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Xml.hx",238,0x7fbf4a5e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(239)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &children){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Xml.hx",242,0x7fbf4a5e)
			{
				...
				bool run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Xml.hx",244,0x7fbf4a5e)
				...
				::Xml run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Xml.hx",255,0x7fbf4a5e)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(256)
						int k = __this->__Field(HX_CSTRING("cur"),true);		HX_STACK_VAR(k,"k");
