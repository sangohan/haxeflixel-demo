...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(326)
		int _g8 = ::openfl::Lib_obj::get_current()->get_stage()->get_stageWidth();		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(326)
		int _g9 = ::openfl::Lib_obj::get_current()->get_stage()->get_stageHeight();		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(326)
