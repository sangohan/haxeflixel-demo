...
::Class SharedObject_obj::resolveClass( ::String name){
	...
	if (((name != null()))){
		...
		if ((::StringTools_obj::startsWith(name,HX_CSTRING("neash.")))){
			HX_STACK_LINE(217)
			::StringTools_obj::replace(name,HX_CSTRING("neash."),HX_CSTRING("openfl."));
		}
		HX_STACK_LINE(221)
		if ((::StringTools_obj::startsWith(name,HX_CSTRING("native.")))){
			HX_STACK_LINE(223)
			::StringTools_obj::replace(name,HX_CSTRING("native."),HX_CSTRING("openfl."));
		}
		HX_STACK_LINE(227)
		if ((::StringTools_obj::startsWith(name,HX_CSTRING("flash.")))){
			HX_STACK_LINE(229)
			::StringTools_obj::replace(name,HX_CSTRING("flash."),HX_CSTRING("openfl."));
		}
		HX_STACK_LINE(233)
