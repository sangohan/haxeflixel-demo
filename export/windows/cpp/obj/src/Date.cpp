...
{
HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Date.hx",26,0xfb0f7c59)
HX_STACK_THIS(this)
...
Float Date_obj::getTime( ){
	HX_STACK_FRAME("Date","getTime",0x0cac7da3,"Date.getTime","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Date.hx",31,0xfb0f7c59)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
::String Date_obj::toString( ){
	HX_STACK_FRAME("Date","toString",0xd2a372cc,"Date.toString","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Date.hx",48,0xfb0f7c59)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
...
::Date Date_obj::fromTime( Float t){
	HX_STACK_FRAME("Date","fromTime",0x44fd3cb7,"Date.fromTime","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Date.hx",57,0xfb0f7c59)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(58)
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_FRAME("Date","fromString",0x5ead97fb,"Date.fromString","E:\\dev_disk\\apps\\haxe\\haxe\\std/cpp/_std/Date.hx",63,0xfb0f7c59)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(64)
	{
		HX_STACK_LINE(64)
