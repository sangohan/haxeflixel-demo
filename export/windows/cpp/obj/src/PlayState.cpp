...
{
		HX_STACK_FRAME("PlayState","destroy",0x6ec756e9,"PlayState.destroy","PlayState.hx",33,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(33)
		this->super::destroy();
	}
...
{
		HX_STACK_FRAME("PlayState","update",0x8d182efa,"PlayState.update","PlayState.hx",41,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(41)
		this->super::update();
	}
