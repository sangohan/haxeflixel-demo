...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/data/HaxelFlixel-tutorial.oep", "assets/data/HaxelFlixel-tutorial.oep");
			type.set ("assets/data/HaxelFlixel-tutorial.oep", Reflect.field (AssetType, "text".toUpperCase ()));
